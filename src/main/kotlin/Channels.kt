...
fun findRepos(cl: CommandLine): ReceiveChannel<Repository> {
    ...
    return coroutineScope.produce(Dispatchers.IO, Channel.UNLIMITED) {
...
fun findArtifacts(
    ...
    return scope.produce(Dispatchers.IO, Channel.UNLIMITED) {
...
fun filterArtifacts(artifactChannel: ReceiveChannel<Artifact>): ReceiveChannel<Artifact> {
    ...
    return scope.produce(Dispatchers.Default, Channel.UNLIMITED) {
